...
app.get('/api/list_games', (req, res) => {
  const games = [
    ...
    { name: 'Shades and Tones', description: 'Connect colours to words!', status: false, imageName: '/shades_tones.svg', colour: '#FFAA64', detailedInfo: 'Using only one and two-word cues, players try to get others to guess a specific hue from the 480 colors on the game board. The closer the guesses are to the target, the more points you earn.', numPlayers: '2-8'},
